...
const Index = () => {
  ...
  const totalPayoffs = useMemo(
    () => monthTransactions.filter(t => accounts.some(a => a.type === 'credit_card' && a.id === t.account) && t.transactionType === 'cc-payment' && !isExcluded(t)).reduce((s, t) => s + Math.abs(t.amount), 0),
