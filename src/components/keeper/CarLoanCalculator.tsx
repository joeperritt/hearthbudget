...
export function CarLoanCalculator({ onBack, householdId, shoppingOnly, onNavigateToProfile }: CarLoanCalculatorProps) {
    ...
    return (
      <div className="max-w-lg mx-auto pb-32">
        <div className="px-6 pt-12 safe-top flex items-center gap-3">
          ...
          <h1 className="font-display text-2xl lg:text-3xl font-bold tracking-tight text-foreground">Car Loan Calculator</h1>
        </div>
